# DATA2902 
## Links 
  - github repository: https://github.sydney.edu.au/tpha0822/DATA2902.git 
  - shinyapps links: https://tpha0822.shinyapps.io/CompleteApp/    
## Description
...
* **Responsive sidebar**  
  ...
  – Long names are displayed in full but wrap neatly.
...
* **Variable lists**  
  - `cat_choices` and `t_choices` are defined near the top; edit as needed for more varaibles.
* **Styling**  
...
* **Interaction with the app** 
  ...
  - In general, the UI and UX are still simple, not too complex and outstanding.
